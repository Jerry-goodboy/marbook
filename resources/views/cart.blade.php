...
@section('content')
        ...
        <label class="weui_cell weui_check_label" for="{{$cart_item->product->id}}">
            ...
            <div class="weui_cell_bd weui_cell_primary">
              <div style="position: relative;">
                ...
                <div style="position: absolute; left: 120px; right: 0; top: 0">
  ...
  <div class="bk_fix_bottom">
    <div class="bk_half_area">
      <button class="weui_btn weui_btn_primary" onclick="toCharge();">结算</button>
    </div>
    <div class="bk_half_area">
      <button class="weui_btn weui_btn_default" onclick="onDelete();">删除</button>
    </div>
  </div>
